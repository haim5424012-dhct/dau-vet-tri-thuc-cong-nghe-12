...
export default function Home() {
  ...
  const [form, setForm] = useState({ student: "", className: "", classCode: "", groupCode: "", reportTitle: "", reportLink: "" });
